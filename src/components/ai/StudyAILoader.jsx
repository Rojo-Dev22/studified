...
const PROMPTS = [
  ...
  'Professor Amare is preparing your response…',
  'Finding textbook references for your topic…',
  'Drawing on years of teaching expertise…',
...
export default function StudyAILoader({ feature = 'chat' }) {
  ...
  return (
    <div className="flex gap-2.5 items-start w-full max-w-md">
      <motion.div
        className="w-7 h-7 rounded-md bg-accent/15 border border-accent/30 flex items-center justify-center shrink-0 relative overflow-hidden"
        animate={{ boxShadow: ['0 0 0 0 rgba(16,185,129,0.4)', '0 0 0 8px rgba(16,185,129,0)', '0 0 0 0 rgba(16,185,129,0)'] }}
        transition={{ duration: 1.6, repeat: Infinity }}
      >
        <Bot className="w-3.5 h-3.5 text-accent relative z-10" />
        <motion.div
